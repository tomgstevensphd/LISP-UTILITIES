...
;;2017
;;ddd
(defun my-dos-dir (path &key wildcard-p attributes format  sort-order
...
#|                 info-list
          ...
          ;;dir lines
          ((fuzzy-match-in-string-list "dir" line-list)  ;; "<dir>"
...
#|  
 (MAKE-DIR-INFOLISTS-FROM-DOS-DIR *testdirout)
 RESULTS=
CUR-DIR HOST VOLNAME DOS-N-DIRS DOS-N-FILES USED-SIZE FREE-BYTES  SERIAL-NUM  ALL-DIRS-INFO ALL-FILES-INFO  ALL-LINES
CUR-DIR= "of C:3-TSLISP PROJECTS TSMYUTILITIES"
HOST= "R   \"C:3-TSLISP PROJECTS TSMYUTILITIES*.LISP\""
VOLNAME= "OS"
SERIAL-NUM= "69"
??ERROR "68"
"File(s)"
...
"4058-766B"
NIL
((:FILE "339 0-CODE-TEMPLATES.lisp" "6; 08/03/2018 08:31" "PM") (:FILE "15903 ARC-curve-function-tests.lisp" "7; 05/08/2018 06:48" "PM") (:FILE "2837 space-show-arglist.lisp" "8; 08/11/2010 02:36" "PM") (:FILE "23466 U-Arrays.lisp" "9; 11/26/2013 03:48" "PM") (:FILE "10138 U-BASIC-functions.lisp" "10; 02/27/2019 07:05" "PM") (:FILE "4527 U-capi - Copy.lisp" "11; 04/22/2016 03:06" "PM") (:FILE "93451 U-trees.lisp" "65; 08/09/2019 08:48" "PM") (:FILE "121474 U-tstring-OLD-make-index-funs.lisp" "66; 04/16/2015 05:18" "PM") (:FILE "255774 U-tstring.lisp" "67; 08/10/2019 03:35" "PM"))
"
0 DIR   \"C:3-TSLISP PROJECTS TSMYUTILITIES*.LISP\"
1  Volume in drive C is OS
2  Volume Serial Number is 4058-766B
3 
4  Directory of C:3-TSLISP PROJECTS TSMYUTILITIES
5 
6 08/03/2018  08:31 PM               339 0-CODE-TEMPLATES.lisp
7 05/08/2018  06:48 PM            15,903 ARC-curve-function-tests.lisp
8 08/11/2010  02:36 PM             2,837 space-show-arglist.lisp
9 11/26/2013  03:48 PM            23,466 U-Arrays.lisp
10 02/27/2019  07:05 PM            10,138 U-BASIC-functions.lisp
11 04/22/2016  03:06 PM             4,527 U-capi - Copy.lisp
65 08/09/2019  08:48 PM            93,451 U-trees.lisp
66 04/16/2015  05:18 PM           121,474 U-tstring-OLD-make-index-funs.lisp
67 08/10/2019  03:35 PM           255,774 U-tstring.lisp
68               62 File(s)      4,452,771 bytes
69                0 Dir(s)  381,027,901,440 bytes free
70 
EOF"
...
|#
;; (MY-DOS-DIR "C:\\3-TS\\LISP PROJECTS TS\\MYUTILITIES\\*.LISP" :wildcard-p T :return-dos-output-t T  :return-line-lists-p T)
;; RESULTS (VALUES CUR-DIR HOST VOLNAME DOS-N-DIRS DOS-N-FILES USED-SIZE FREE-BYTES  SERIAL-NUM  ALL-DIRS-INFO ALL-FILES-INFO  ALL-LINES)
#|
CUR-DIR= " C:\\3-TS\\LISP PROJECTS TS\\MYUTILITIES"
HOST= "  \"C:\\3-TS\\LISP PROJECTS TS\\MYUTILITIES\\*.LISP\""
VOLNAME= "OS"
DOS-N-DIRS= "4058-766B"  X
DOS-N-FILES= "ir(s)"   X
USED-SIZE= "2"  X
FREE-BYTES= "4460838"  X
SERIAL-NUM= "bytes"  X
ALL-DIRS-INFO= NIL  OK
ALL-FILES-INFO= ((:FILE "0-CODE-TEMPLATES.lisp" "08/03/2018; 08:31 PM" "339") (:FILE "ARC-curve-function-tests.lisp" "05/08/2018; 06:48 PM" "15903") (:FILE "space-show-arglist.lisp" "08/11/2010; 02:36 PM" "2837") (:FILE "U-Arrays.lisp" "11/26/2013; 03:48 PM" "23466") (:FILE "U-BASIC-functions.lisp" "02/27/2019; 07:05 PM" "10138") (:FILE "U-capi - Copy.lisp" "04/22/2016; 03:06 PM" "4527") (:FILE "U-capi-buttons-etc-old.lisp" "04/25/2014; 08:14 PM" "48236") (:FILE "U-capi-buttons-etc.lisp" "10/12/2016; 03:04 PM" "112977")  ... ETC
ALL-LINES= "DIR   \"C:\\3-TS\\LISP PROJECTS TS\\MYUTILITIES\\*.LISP\"
 Volume in drive C is OS
 Volume Serial Number is 4058-766B
...
04/16/2015  05:18 PM           121,474 U-tstring-OLD-make-index-funs.lisp
08/10/2019  03:35 PM           255,774 U-tstring.lisp
              62 File(s)      4,460,838 bytes
               0 Dir(s)  382,531,231,744 bytes free
"
|#
...
;; not work (MAKE-DIR-INFOLISTS-FROM-DOS-DIR "C:\\3-TS\\LISP PROJECTS TS":RETURN-ALL-LINES-P T)
...
;;2019
;;ddd
(defun my-ensure-dir-exists (path  &key (chk-is-filepath-p T)  )
...
(defun make-dated-pathname (filename-base 
                &key (root "C:\\3-TS\\LISP PROJECTS TS\\")
                         (file-ext "lisp") no-date-p incl-time-p use-existing-ext-p)
  "In U-files, takes a filename-base string and adds the root string before and the date plus period file-ext onto the end. If no-date-p, doesn't include date.  When (or (null file-ext) use-existing-ext-p), then uses existing file-type."
  (let
      ((pathname)
       (date)
       )
    (when (or (null file-ext) use-existing-ext-p)
      (setf file-ext (pathname-type  filename-base)
            filename-base (pathname-name filename-base)))
    (cond
     ((null no-date-p)
...
;;2017
;;ddd
(defun clean-path-str (pathstr &key (slash-type :forward) enclose-in-quotes-p  
                               remove-extra-quotes-p wildcard-p)
  ...
  (cond
   ((or wildcard-p (equal slash-type :back))
