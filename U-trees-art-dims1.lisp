...
;;2019
;;ddd
(defun make-dim-tree-nodes-list  (csarttree-specs &key
                                                  #|  tree-num-list ;;(rootmult 1)
                                   group-by-val-p  order-by-rank-p
...
;;SSSSSS START FINISH make-dim-tree-nodes-list
    (incf root-leveln)
...
;;NO-ONLY IF WANT TO MAKE TREE USING CSQ FOUND CSYMS
;;GOAL OUTPUT EG. (((CS) "CS" :S (((CS HS) "CS.HS" :S (((CS HS 1) "CS.HS.1" :C CAREFOROTHERS :S (((CS HS 1 1) "CS.HS.1.1" :C INTIMATE) ((CS HS 1 2) "CS.HS.1.2" :C UNDERSTANDING))) ((CS HS 2) "CS.HS.2" :C INTIMATE :S (((CS HS 2 1) "CS.HS.2.1" :C FLEXIBLE) ((CS HS 2 2) "CS.HS.2.2" :C EXUBERANT) ((CS HS 2 3) "CS.HS.2.3" :C LOVEDANCE))) ((CS HS 3) "CS.HS.3"))) ((CS MS) "CS.MS" :S (((CS MS MS1) "CS.MS.MS1" :S (((CS MS MS1 1) "CS.MS.MS1.1") ((CS MS MS1 2) "CS.MS.MS1.2"))))))))
;;FROM INPUT '(CS (HS (1 (1 2) 2 (1 2 3) 3))  (MS (MS1 (1 2))))
;; (make-dim-tree-nodes-list   '(CS (HS (1 (1 2) 2 (1 2 3) 3))  (MS (MS1 (1 2)))))
