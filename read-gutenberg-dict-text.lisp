;;*********************** read-gutenberg-dict-text.lisp ******************************
;;READS DICTIONARY ENTRIES IN the GUTENBERG PROJECT WEBSTER DICTIONARY
;;
(defun read-gutenberg-text-entry (text-entry-str)
 "In read-gutenberg-dict-text, "
 (let
     ((line)
      (defword)
      (speech-part)
   ...
   ;;end let, read-gutenberg-text-entry
   ))
;;downloaded parser files: unzipped: C:\Users\Sherry Bene Stevens\AppData\Local\Microsoft\Windows\Temporary Internet Files\Content.IE5\LACG8YYM\tagger-master.zip\
